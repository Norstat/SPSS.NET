...
namespace Spss
{
    ...
    public class SpssThinWrapper
    {
        ...
        /// </remarks>
        [CLSCompliant(false)]
        unsafe protected delegate ReturnCode spssFreeVarNamesDelegate(/*char** */ IntPtr varNames, int* varTypes, int numVars);
        ...
        /// </remarks>
        protected delegate ReturnCode spssGetVarHandleDelegate(int handle, /*[MarshalAs(UnmanagedType.VBByRefStr)] ref string varName*/ IntPtr varName, out double varHandle);
        ...
        public delegate ReturnCode spssGetVarLabelLongDelegate(int handle, IntPtr varName, IntPtr labelBuff /*[MarshalAs(UnmanagedType.VBByRefStr)] ref string labelBuff*/, int lenBuff, out int lenLabel);
        ...
        /// </remarks>
        [CLSCompliant(false)]
        unsafe protected delegate ReturnCode spssGetVarNValueLabelsDelegate(int handle, IntPtr varName, out double* values, /*out char***/ out IntPtr labels, out int numLabels);
        [CLSCompliant(false)]
        ...
        /// </remarks>
        [CLSCompliant(false)]
        unsafe protected delegate ReturnCode spssGetVarNamesDelegate(int handle, out int numVars, /*out char** */ out IntPtr varNames, out int* varTypes);
